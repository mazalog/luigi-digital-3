...
const initState = {
    ...
    article: {},
    gender: 'FISICO',
    modal: localStorage.getItem('vali') ? false : true,
}
...
const rootReducer = (state = initState, action) => {
    ...
    if (action.type === "ADD_LIST") {
        ...
        state.inCard.find(x => x.id === action.item.id && x.size === action.item.size && x.image === action.item.image).piece++
